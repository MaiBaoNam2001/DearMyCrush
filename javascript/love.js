(function (window) {
    ...
    Seed.prototype = {
        ...
        drawCircle: function () {
            ...
            var point = circle.point, color = circle.color, scale = circle.scale, radius = circle.radius;
            ctx.save();
            ctx.fillStyle = color;
            ctx.translate(point.x, point.y);
        ...
        drawText: function () {
            ...
            ctx.fillText("Click đi cậu", 23, 10);
            ctx.restore();
        },
        clear: function () {
            var ctx = this.tree.ctx, circle = this.circle;
    ...
    Tree.prototype = {
        ...
        flower: function (num) {
            var s = this, blooms = s.bloomCache.splice(0, num);
            for (var i = 0; i < blooms.length; i++) {
                s.addBloom(blooms[i]);
            }
            blooms = s.blooms;
